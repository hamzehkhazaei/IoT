...
set multiplot layout 2, 1 # title "SAVI-IoT Platform -- Edges"
# set size ratio 0.39
set termoption dashed

# set xlabel "Time" font "Arial, 15"
set ytics nomirror
set y2tics
set tics font "Arial, 15"
set key font "Arial, 15" below
...
set size 0.95, 0.45  # 0.32
set ylabel "VMs (#)" font "Arial, 15" offset 2
set y2label "Containers (#)" font "Arial, 15" offset -1
set format y "%2.0f" 
set format y2 "%2.0f"
set ytics 1
set yrange [0:4]
...
set y2range [0:14]
set y2tics 2
plot    monitor_file using 4 with lines axis x1y1 linestyle 1 title "MG-Spark-VM", \
        monitor_file using 8 with lines axis x1y1 linestyle 2 title "MG-Kafka-VM", \
        monitor_file using 13 with lines axis x1y2 linestyle 11 title "MG-Spark-Cont", \
        monitor_file using 17 with lines axis x1y2 linestyle 12 title "MG-Kafka-Cont", \
